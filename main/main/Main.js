      ...
      return (
        <SafeAreaView style={{flex:1}}>
         ...
         <View style={styles.dl_big_v}>
             ...
             {
             is_login?
                 <Image source={{uri:'http://pic30.nipic.com/20130619/9885883_210838271000_2.jpg'}} 
             style={styles.tx}/>
             :
             ...
             {
              is_login?  
               <Text style={{fontSize:18,fontWeight:'500',marginLeft:10}}>你好!,张三</Text>
              :
              <Text style={{fontSize:18,fontWeight:'500',marginLeft:10}}>你好!,请登录</Text>
             }
             
             </View>
             <TouchableOpacity onPress={()=>{
                 is_login?this.show_exit():this.login()
             }}>
             <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center'}}>
                 <Text style={{fontSize:16,color:global.t_color}}>{is_login?'退出':'去登录'}</Text>
